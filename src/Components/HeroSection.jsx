  ...
  return (
    <div className="relative h-163 overflow-hidden ">
        ...
        <AnimatePresence mode="sync">
          {activeMovie && (
            <motion.div
              ...
              style={{
                backgroundImage: `url(${activeMovie?.image?.original})`,
              }}
            />
          )}
        </AnimatePresence>
      ...
      <button
        ...
        variant="ghost"
        onClick={prevBtn}
        className="absolute left-6 top-1/2 -translate-y-1/2 z-10 cursor-pointer bg-zinc-800/80 rounded-4xl text-white p-2 hover:bg-zinc-700"
      >
        <ChevronLeft />
      </button>
      <div
      ...
      <button
        size="icon"
        onClick={nextBtn}
        className="absolute right-6 top-1/2 -translate-y-1/2 z-10 cursor-pointer bg-zinc-800/80 rounded-4xl text-white p-2 hover:bg-zinc-700"
      >
        <ChevronRight />
      </button>
    </div>
